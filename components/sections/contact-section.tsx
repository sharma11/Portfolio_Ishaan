        ...
        <div className="grid gap-8 md:grid-cols-[1.2fr_1fr] md:gap-16 lg:gap-24">
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-4 md:space-y-8">
              <a
                href="mailto:ishaansharma30012000@gmail.com"
              ...
              >
                ...
                <p className="text-base text-foreground transition-colors group-hover:text-foreground/70 md:text-2xl">
                  ishaansharma30012000@gmail.com
                </p>
              </a>

              <a
                href="tel:+918447559618"
                className={`group block transition-all duration-700 ${
                  isVisible ? "translate-x-0 opacity-100" : "-translate-x-16 opacity-0"
                }`}
              ...
              >
                ...
                <p className="text-base text-foreground md:text-2xl">Delhi, India</p>
              </div>
              ...
              >
                {[
                  { label: "GitHub", href: "https://github.com/sharma11" },
                  { label: "LinkedIn", href: "https://www.linkedin.com/in/ishaan-sharma-083177350/" },
                ].map((social) => (
                  <a
                    key={social.label}
                    href={social.href}
